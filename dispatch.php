...
if (!$stmt->bind_param('ssssss', $_POST['JostonCaller'], $_POST['JostonContact'],
$_POST['incidentType'], $_POST['JostonLocation'], $_POST['incidentDesc'], $incidentStatus))
...
<tr>
<td>Caller's Name :</td>
<td><?php echo $_POST['JostonCaller'] ?>
<input type="hidden" name="JostonCaller" id="JostonCaller"
value="<?php echo $_POST['JostonCaller'] ?>"></td>
</tr>
<tr>
<td>Contact No :</td>
<td><?php echo $_POST['JostonContact'] ?>
<input type="hidden" name="JostonContact" id="JostonContact"
value="<?php echo $_POST['JostonContact'] ?>"></td>	
</tr>
<tr>
<td>Location :</td>
<td><?php echo $_POST['JostonLocation'] ?>
<input type="hidden" name="JostonLocation" id="JostonLocation"
value="<?php echo $_POST['JostonLocation'] ?>"></td>	
</tr>
<tr>
<td>Incident Type :</td>
